...
class GlobalPathWay(nn.Module):
    def __init__(self):
        ...
        self.residual6_1 = self.make_layer(_Residual_Block, 6, in_channel=128, out_channel=128,kernel_size=3,padding=1,stride=1)
        self.residual6_2 = self.make_layer(_Residual_Block, 6, in_channel=128, out_channel=128,kernel_size=3,padding=1,stride=1)
        self.residual6_3 = self.make_layer(_Residual_Block, 6, in_channel=128, out_channel=128, kernel_size=3, padding=1, stride=1)
        self.residual = self.make_layer(_Residual_Block, 1, in_channel=192, out_channel=192,kernel_size=3,padding=1,stride=1)
