...
if __name__ == '__main__':
    ...
    parser.add_argument("-source_root", "--source_root", help = "specify your source dir", default = "/media/hyo/文档/Dataset/face_dataset_v2/lfw", type = str)
    parser.add_argument("-dest_root", "--dest_root", help = "specify your destination dir", default = "/media/hyo/文档/Dataset/face_dataset_v2/lfw_aligned", type = str)
    parser.add_argument("-crop_size", "--crop_size", help = "specify size of aligned faces, align and crop with padding", default = 224, type = int)
    ...
    for subfolder in tqdm(os.listdir(source_root)):
        ...
        for image_name in os.listdir(os.path.join(source_root, subfolder)):
            ...
            img_warped = Image.fromarray(warped_face[0])
            img_warped.save(os.path.join(dest_root, subfolder, image_name.split('.')[0] + '.png'))
